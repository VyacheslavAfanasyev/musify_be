...
✅ **Библиотека настроена для публикации в NPM!**

Пакет готов к публикации и может быть использован в продакшене. Подробная инструкция по публикации находится в файле [NPM_PUBLISH.md](./NPM_PUBLISH.md).
...
2. **Использование в микросервисах:**
   ```json
   {
     "dependencies": {
       "@app/shared": "^1.0.0"
...
3. Версионирование остается таким же (SemVer)
4. Можно использовать разные версии в разных сервисах при необходимости
...
# Опубликовать с автоматическим обновлением версии
npm run shared:publish:patch
npm run shared:publish:minor
npm run shared:publish:major
```
